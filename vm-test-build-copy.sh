...
build_and_copy_with_scenarios ./contracts/core/wmoax-swap $VM_REPO_PATH/test/wmoax-swap
...
build_and_copy_with_scenarios ./contracts/examples/ping-pong-moax $VM_REPO_PATH/test/ping-pong-moax
