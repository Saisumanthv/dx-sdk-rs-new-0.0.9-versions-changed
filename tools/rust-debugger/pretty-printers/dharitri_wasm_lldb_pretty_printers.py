...
DEBUG_API_TYPE = "dharitri_wasm_debug::tx_mock::tx_context_ref::TxContextRef"
ANY_NUMBER = "[0-9]+"
ANY_TYPE = ".*"
...
# 2. Dharitri wasm - Managed basic types
MOD_PATH = "dharitri_wasm::types::managed::basic"
...
# 3. Dharitri wasm - Managed wrapped types
MOD_PATH = "dharitri_wasm::types::managed::wrapped"
...
# 4. Dharitri wasm - Managed multi value types

# 5. Dharitri wasm - heap
MOD_PATH = "dharitri_wasm::types::heap"
...
MOD_PATH = "dharitri_codec::multi_types"
...
def __lldb_init_module(debugger: SBDebugger, dict):
    ...
    for rust_type, handler_class in DHARITRI_WASM_TYPE_HANDLERS:
        ...
        summary_command = f'type summary add -x "^{rust_type}$" -F {python_module_name}.{summary_function_name} --category dharitri-wasm'
        debugger.HandleCommand(summary_command)
        # print(f"Registered: {summary_command}")

    # Enable categories
    debugger.HandleCommand('type category enable dharitri-wasm')
