...
use crate::{
    ...
    types::{
        BigUint, ContractCall, DctLocalRole, DctTokenType, ManagedAddress, ManagedBuffer,
        TokenIdentifier,
    },
};
    ...
    SA: CallTypeApi + 'static,
{
    ...
    pub fn issue_and_set_all_roles(
        ...
        let token_type_name = match token_type {
            ...
            DctTokenType::NonFungible => &b"NFT"[..],
            DctTokenType::SemiFungible => &b"SFT"[..],
    ...
    pub fn control_changes(
        ...
        let mut contract_call = self.dct_system_sc_call_no_args(b"controlChanges");
        contract_call.push_endpoint_arg(token_identifier);
