...
impl BlockchainApi for crate::VmApiImpl {
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_state_root_hash(&self) -> dharitri_wasm::types::ManagedByteArray<Self, 32> {
        unsafe {
            let result_handle = mBufferNew();
            managedGetStateRootHash(result_handle);
            dharitri_wasm::types::ManagedByteArray::from_raw_handle(result_handle)
        }
    }
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_tx_hash(&self) -> dharitri_wasm::types::ManagedByteArray<Self, 32> {
        unsafe {
            let result_handle = mBufferNew();
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_block_random_seed(&self) -> dharitri_wasm::types::ManagedByteArray<Self, 48> {
        unsafe {
            let result_handle = mBufferNew();
    ...
    #[inline]
    #[cfg(not(feature = "unmanaged-ei"))]
    fn get_prev_block_random_seed(&self) -> dharitri_wasm::types::ManagedByteArray<Self, 48> {
        unsafe {
            let result_handle = mBufferNew();
