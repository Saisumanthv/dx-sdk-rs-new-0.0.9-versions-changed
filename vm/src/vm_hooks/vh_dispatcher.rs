...
impl VMHooks for VMHooksDispatcher {
    ...
    fn managed_get_back_transfers(&self, dct_transfer_value_handle: i32, call_value_handle: i32) {
        self.handler
            .managed_get_back_transfers(dct_transfer_value_handle, call_value_handle);
    }
