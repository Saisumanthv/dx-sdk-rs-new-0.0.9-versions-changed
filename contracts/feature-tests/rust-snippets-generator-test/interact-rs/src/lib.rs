...
const GATEWAY: &str = dharitri_sdk::blockchain::DEVNET_GATEWAY;
...
impl State {
    ...
    async fn deploy(&mut self) {
        let result: dharitri_sc_snippets::InteractorResult<()> = self
            .interactor
            .sc_deploy(
                self.contract
                    .init()
    ...
    async fn no_arg_one_result_endpoint(&mut self) {
        let result: dharitri_sc_snippets::InteractorResult<u64> = self
            .interactor
            .sc_call_get_result(
                self.contract
    ...
    async fn one_arg_one_result_endpoint(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<BigUint<DebugApi>> = self
            .interactor
            .sc_call_get_result(
                self.contract
    ...
    async fn multi_result(&mut self) {
        let _arg = TokenIdentifier::from_dct_bytes(&b""[..]);

        let result: dharitri_sc_snippets::InteractorResult<MultiValueVec<BigUint<DebugApi>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .multi_result(_arg)
    ...
    async fn nested_result(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<ManagedVec<DebugApi, ManagedVec<DebugApi, BigUint<DebugApi>>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .nested_result(_arg)
    ...
    async fn custom_struct(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<MyCoolStruct<DebugApi>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .custom_struct(_arg)
    ...
    async fn optional_type(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<OptionalValue<TokenIdentifier<DebugApi>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .optional_type(_arg)
    ...
    async fn option_type(&mut self) {
        let _arg = Option::Some(ManagedVec::from_single_item(TokenIdentifier::from_dct_bytes(&b""[..])));

        let result: dharitri_sc_snippets::InteractorResult<Option<u64>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .option_type(_arg)
    ...
    async fn dct_token_payment(&mut self) {
        let _arg = OptionalValue::Some(DctTokenPayment::new(
                TokenIdentifier::from_dct_bytes(&b""[..]),
                0u64,
                BigUint::from(0u64)
            ));

        let result: dharitri_sc_snippets::InteractorResult<DctTokenPayment<DebugApi>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .dct_token_payment(_arg)
                    .into_blockchain_call()
                    .from(&self.wallet_address)
                    .gas_limit(DEFAULT_GAS_LIMIT)
                    .into(),
    ...
    async fn moax_or_dct_payment(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<MoaxOrDctTokenIdentifier<DebugApi>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .moax_or_dct_payment(arg)
                    .into_blockchain_call()
                    .from(&self.wallet_address)
                    .gas_limit(DEFAULT_GAS_LIMIT)
                    .into(),
    ...
    async fn managed_buffer(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<MultiValueVec<ManagedVec<DebugApi, MyCoolStruct<DebugApi>>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .managed_buffer(_arg)
    ...
    async fn multi_value_2(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<MultiValue2<u64, BigUint<DebugApi>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .multi_value_2(arg)
    ...
    async fn multi_value_4(&mut self) {
        ...
        let result: dharitri_sc_snippets::InteractorResult<MultiValue4<u64, BigUint<DebugApi>, MyCoolStruct<DebugApi>, TokenIdentifier<DebugApi>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
                    .multi_value_4(arg)
    ...
    async fn complex_multi_values(&mut self) {
        let arg = MultiValueVec::from(vec![MultiValue3::from((TokenIdentifier::from_dct_bytes(&b""[..]), 0u64, BigUint::<DebugApi>::from(0u64)))]);

        let result: dharitri_sc_snippets::InteractorResult<MultiValueVec<MultiValue3<TokenIdentifier<DebugApi>, u64, BigUint<DebugApi>>>> = self
            .interactor
            .sc_call_get_result(
                self.contract
