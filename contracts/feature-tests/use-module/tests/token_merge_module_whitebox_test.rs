use dharitri_sc::{
    ...
    types::{Address, DctTokenPayment, ManagedVec},
};
...
use dharitri_sc_scenario::{
    ...
    scenario_model::{
        Account, AddressValue, CheckAccount, CheckStateStep, ScCallStep, SetStateStep, TxDCT,
    },
...
fn test_token_merge() {
    ...
    world.set_state_step(
        SetStateStep::new()
            ...
            .put_account(
                ...
                Account::new()
                    .nonce(1)
                    .dct_balance(FUNGIBLE_TOKEN_ID_EXPR, FUNGIBLE_AMOUNT)
                    .dct_nft_all_properties(
                        NFT_TOKEN_ID_EXPR,
                        FIRST_NFT_NONCE,
                        NFT_AMOUNT,
            ...
            .put_account(
                ...
                Account::new()
                    ...
                    .dct_roles(MERGED_TOKEN_ID_EXPR, roles),
            ),
    );
    ...
    let nft_transfers = vec![
        TxDCT {
            dct_token_identifier: NFT_TOKEN_ID.into(),
            nonce: FIRST_NFT_NONCE.into(),
            dct_value: NFT_AMOUNT.into(),
        },
        TxDCT {
            dct_token_identifier: NFT_TOKEN_ID.into(),
    ...
    world.whitebox_call(
        &use_module_whitebox,
        ScCallStep::new().from(USER_ADDRESS_EXPR).dct_transfer(
            MERGED_TOKEN_ID_EXPR,
            1,
            NFT_AMOUNT,
        ),
    ...
    let dct_transfers = vec![
        ...
        TxDCT {
            dct_token_identifier: FUNGIBLE_TOKEN_ID.into(),
            nonce: 0u64.into(),
            dct_value: FUNGIBLE_AMOUNT.into(),
        },
    ];
    ...
    let combined_transfers = vec![
        ...
        TxDCT {
            dct_token_identifier: MERGED_TOKEN_ID.into(),
            nonce: 2u64.into(),
            dct_value: NFT_AMOUNT.into(),
        },
    ];
    ...
    world.check_state_step(CheckStateStep::new().put_account(
        USER_ADDRESS_EXPR,
        CheckAccount::new().dct_balance(FUNGIBLE_TOKEN_ID_EXPR, FUNGIBLE_AMOUNT),
    ));
}
