use dharitri_wasm::types::{Address, DctTokenPayment, ManagedVec, MultiValueEncoded};
...
use dharitri_wasm_modules::governance::{
    ...
    pub fn propose(
        ...
        let result = self.b_mock.execute_dct_transfer(
            ...
            |sc| {
                ...
                for p in payments {
                    payments_managed.push(DctTokenPayment::new(
...
fn change_gov_config_test() {
    ...
    gov_setup.b_mock.check_dct_balance(
        &first_user_addr,
        GOV_TOKEN_ID,
