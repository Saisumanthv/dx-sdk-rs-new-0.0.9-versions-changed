...
dharitri_sc_wasm_adapter::endpoints! {
    ...
    (
        ...
        send_dct => send_dct
        send_dct_with_fees => send_dct_with_fees
        send_dct_twice => send_dct_twice
        send_dct_direct_multi_transfer => send_dct_direct_multi_transfer
        issue_fungible_token => issue_fungible_token
        local_mint => local_mint
        local_burn => local_burn
        get_dct_local_roles => get_dct_local_roles
        get_dct_token_data => get_dct_token_data
        is_dct_frozen => is_dct_frozen
        is_dct_paused => is_dct_paused
        is_dct_limited_transfer => is_dct_limited_transfer
