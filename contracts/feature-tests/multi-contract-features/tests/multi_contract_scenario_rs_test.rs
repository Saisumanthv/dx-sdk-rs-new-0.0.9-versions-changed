...
fn mcf_example_feature_rs() {
    dharitri_sc_scenario::run_rs("scenarios/mcf-example-feature.scen.json", world());
}

#[test]
fn mcf_external_pure_rs() {
    dharitri_sc_scenario::run_rs("scenarios/mcf-external-pure.scen.json", world());
}

#[test]
fn mcf_external_get_rs() {
    dharitri_sc_scenario::run_rs("scenarios/mcf-external-get.scen.json", world());
}
