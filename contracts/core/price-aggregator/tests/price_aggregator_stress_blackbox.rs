...
use dharitri_sc::{
    ...
    types::MoaxOrDctTokenIdentifier,
};
use dharitri_sc_modules::{pause::ProxyTrait, staking::ProxyTrait as _};
...
const PRICE_AGGREGATOR_PATH_EXPR: &str = "mxsc:../output/dharitri-price-aggregator-sc.mxsc.json";
