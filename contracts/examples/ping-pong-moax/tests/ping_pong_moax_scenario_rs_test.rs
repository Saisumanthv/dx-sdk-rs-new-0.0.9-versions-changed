...
fn ping_pong_call_ping_rs() {
    dharitri_sc_scenario::run_rs("scenarios/ping-pong-call-ping.scen.json", world());
}
...
fn ping_pong_call_ping_twice_rs() {
    dharitri_sc_scenario::run_rs("scenarios/ping-pong-call-ping-twice.scen.json", world());
}
...
fn ping_pong_call_pong_rs() {
    dharitri_sc_scenario::run_rs("scenarios/ping-pong-call-pong.scen.json", world());
}

#[test]
fn ping_pong_call_pong_all_rs() {
    dharitri_sc_scenario::run_rs("scenarios/ping-pong-call-pong-all.scen.json", world());
}
...
fn ping_pong_call_pong_twice_rs() {
    dharitri_sc_scenario::run_rs("scenarios/ping-pong-call-pong-twice.scen.json", world());
}
...
fn ping_pong_init_rs() {
    dharitri_sc_scenario::run_rs("scenarios/ping-pong-init.scen.json", world());
}
