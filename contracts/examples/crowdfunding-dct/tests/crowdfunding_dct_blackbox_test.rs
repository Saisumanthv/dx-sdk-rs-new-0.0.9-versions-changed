...
use dharitri_sc::types::MoaxOrDctTokenIdentifier;
...
fn world() -> ScenarioWorld {
    ...
    blockchain.register_contract(CF_PATH_EXPR, crowdfunding_dct::ContractBuilder);
    blockchain
}
...
fn crowdfunding_scenario_rust_test() {
    ...
    let mut cf_sc = ContractInfo::<crowdfunding_dct::Proxy<StaticApi>>::new("sc:crowdfunding");
    ...
    world.sc_deploy(
        ScDeployStep::new()
            ...
            .call(cf_sc.init(
                2_000u32,
                deadline,
                MoaxOrDctTokenIdentifier::dct(cf_token_id_value),
            )),
    );
