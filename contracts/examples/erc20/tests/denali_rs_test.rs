...
fn allowance_callercaller_rs() {
    dharitri_wasm_debug::denali_rs("denali/allowance_CallerCaller.scen.json", contract_map());
}

#[test]
fn allowance_callerother_rs() {
    dharitri_wasm_debug::denali_rs("denali/allowance_CallerOther.scen.json", contract_map());
}

#[test]
fn allowance_othercaller_rs() {
    dharitri_wasm_debug::denali_rs("denali/allowance_OtherCaller.scen.json", contract_map());
}

#[test]
fn allowance_othereqother_rs() {
    dharitri_wasm_debug::denali_rs("denali/allowance_OtherEqOther.scen.json", contract_map());
}

#[test]
fn allowance_otherneqother_rs() {
    dharitri_wasm_debug::denali_rs("denali/allowance_OtherNEqOther.scen.json", contract_map());
}

#[test]
fn approve_caller_positive_rs() {
    dharitri_wasm_debug::denali_rs("denali/approve_Caller-Positive.scen.json", contract_map());
}

#[test]
fn approve_caller_zero_rs() {
    dharitri_wasm_debug::denali_rs("denali/approve_Caller-Zero.scen.json", contract_map());
}

#[test]
fn approve_other_positive_rs() {
    dharitri_wasm_debug::denali_rs("denali/approve_Other-Positive.scen.json", contract_map());
}

#[test]
fn approve_other_zero_rs() {
    dharitri_wasm_debug::denali_rs("denali/approve_Other-Zero.scen.json", contract_map());
}

#[test]
fn approve_switchcaller_rs() {
    dharitri_wasm_debug::denali_rs("denali/approve_SwitchCaller.scen.json", contract_map());
}

#[test]
fn balanceof_caller_rs() {
    dharitri_wasm_debug::denali_rs("denali/balanceOf_Caller.scen.json", contract_map());
}

#[test]
fn balanceof_noncaller_rs() {
    dharitri_wasm_debug::denali_rs("denali/balanceOf_NonCaller.scen.json", contract_map());
}

#[test]
fn not_payable_rs() {
    dharitri_wasm_debug::denali_rs("denali/not_payable.scen.json", contract_map());
}

#[test]
fn totalsupply_positive_rs() {
    dharitri_wasm_debug::denali_rs("denali/totalSupply_Positive.scen.json", contract_map());
}

#[test]
fn totalsupply_zero_rs() {
    dharitri_wasm_debug::denali_rs("denali/totalSupply_Zero.scen.json", contract_map());
}
...
fn transfer_caller_positive_rs() {
    dharitri_wasm_debug::denali_rs("denali/transfer_Caller-Positive.scen.json", contract_map());
}
...
fn transfer_caller_zero_rs() {
    dharitri_wasm_debug::denali_rs("denali/transfer_Caller-Zero.scen.json", contract_map());
}
...
fn transfer_other_nooverflow_rs() {
    dharitri_wasm_debug::denali_rs("denali/transfer_Other-NoOverflow.scen.json", contract_map());
}

#[test]
fn transfer_other_positive_rs() {
    dharitri_wasm_debug::denali_rs("denali/transfer_Other-Positive.scen.json", contract_map());
}
...
fn transfer_other_zero_rs() {
    dharitri_wasm_debug::denali_rs("denali/transfer_Other-Zero.scen.json", contract_map());
}
