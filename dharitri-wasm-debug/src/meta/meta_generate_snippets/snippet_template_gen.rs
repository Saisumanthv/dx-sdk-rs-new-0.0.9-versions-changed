...
use dharitri_wasm::abi::ContractAbi;
...
pub(crate) fn write_snippet_constants(file: &mut File) {
    writeln!(file, "const GATEWAY: &str = dharitri_interact_snippets::moars::blockchain::rpc::DEVNET_GATEWAY;
