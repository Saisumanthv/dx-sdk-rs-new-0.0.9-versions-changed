...
fn init_rust_types_map() -> HashMap<&'static str, RustTypeString> {
    ...
    m.insert(
        ...
        RustTypeString {
            type_name: "MoaxOrDctTokenIdentifier".to_string() + DEBUG_API_SUFFIX,
    ...
    m.insert(
        "DctTokenPayment",
        RustTypeString {
            type_name: "DctTokenPayment".to_string() + DEBUG_API_SUFFIX,
    ...
    m.insert(
        ...
        RustTypeString {
            type_name: "MoaxOrDctTokenPayment".to_string() + DEBUG_API_SUFFIX,
