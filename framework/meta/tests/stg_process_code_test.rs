use dharitri_sc_meta::scen_test_gen::{format_test_fn_go, process_code};

const GO_TEST_1: &str = r#"#[test]
fn test_1_go() {
    dharitri_sc_scenario::run_go("scenarios/test1.scen.json");
}
"#;

const GO_TEST_0_1_2: &str = r#"#[test]
fn test_0_go() {
    dharitri_sc_scenario::run_go("scenarios/test0.scen.json");
}
...
#[test]
fn test_2_go() {
    dharitri_sc_scenario::run_go("scenarios/test2.scen.json");
}
"#;
